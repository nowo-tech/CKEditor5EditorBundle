# CKEditor 5 Editor Bundle — Demo (Symfony 7.4)
...
The app pins **Symfony 7.4.*** via `extra.symfony.require` in `composer.json`. Symfony **8.0** / **8.1** is covered by the sibling demo in `demo/symfony8`.
...
make up
make install
# Open http://localhost:8020 (or set PORT in .env)
```
