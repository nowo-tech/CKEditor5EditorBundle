...
After installation, enable MCP in Cursor and ensure the `engram` server appears in your MCP list. The agent can then use remember/recall flows across sessions. Data stays local unless you opt into optional embedding features (see Engram docs).
