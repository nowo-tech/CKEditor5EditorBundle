...
2. **Product behavior** — what **Ckeditor5EditorBundle** guarantees to applications that integrate it (see [`USAGE.md`](USAGE.md), [`CONFIGURATION.md`](CONFIGURATION.md), [`INSTALLATION.md`](INSTALLATION.md)). **PHPUnit** and **PHPStan** (and **Vitest** when applicable) enforce contracts in CI where applicable.
...
**Supported platforms (dependency limits):**

| Symfony | PHP (minimum) |
| ------- | ------------- |
| **6.4**, **7.x** (incl. **7.4**) | **8.2+** |
| **8.0**, **8.1** | **8.4+** |

CI matrix: **PHP 8.2–8.5** × **Symfony 7.0 / 7.4 / 8.0 / 8.1**. The FrankenPHP demo pins **8.1.***. Details: [`INSTALLATION.md`](INSTALLATION.md#requirements).

---

## Bundle functional scope

**Goal:** Symfony form type for rich text using CKEditor 5 (GPL OSS build via Vite). FOS-style YAML profiles, Docker makefile workflow.
