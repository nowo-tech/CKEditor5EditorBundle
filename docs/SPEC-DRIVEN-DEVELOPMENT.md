...
1. **Product behavior** — what **Ckeditor5EditorBundle** guarantees to applications that integrate it (see [`USAGE.md`](USAGE.md), [`CONFIGURATION.md`](CONFIGURATION.md), [`INSTALLATION.md`](INSTALLATION.md)). **PHPUnit** and **PHPStan** enforce contracts in CI where applicable.
...
CI matrix: **PHP 8.2–8.5** × **Symfony 7.0 / 7.4 / 8.0 / 8.1**. Demos pin **7.4.*** and **8.1.*** respectively. Details: [`INSTALLATION.md`](INSTALLATION.md#requirements).
